...
public class smartphonesForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					smartphonesForm frame = new smartphonesForm();
...
setTitle("SmartPHONE");
		...
		btnNewButton.setBounds(362, 43, 121, 23);
		panel.add(btnNewButton);
		
		 JComboBox UserComboBox = new JComboBox(l);
		 UserComboBox.setForeground(Color.RED);
		...
		UserComboBox.setBounds(164, 99, 135, 24);
		...
		btnNewButton_1.setBounds(357, 88, 126, 23);
		...
		btnNewButton_2.setBounds(362, 135, 142, 23);
