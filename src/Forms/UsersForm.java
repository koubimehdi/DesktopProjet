...
public class UsersForm extends JFrame {
    ...
    public static ServerDaoRemote lookUpSalleDaoRemote() throws NamingException {
		...
		return (ServerDaoRemote) context.lookup("ejb:EarWLocal/Server/ServiceDao!dao.ServerDaoRemote");}
	/**
...
setTitle("Users");
		...
		lblNewLabel.setBounds(10, 32, 108, 14);
		panel.add(lblNewLabel);
		
		nomField = new JTextField();
		nomField.setFont(new Font("Tw Cen MT", Font.PLAIN, 11));
		nomField.setBounds(124, 25, 135, 21);
		panel.add(nomField);
		...
		btnNewButton.setBounds(335, 23, 121, 33);
		...
		btnNewButton_1.setBounds(335, 81, 121, 33);
		...
		btnNewButton_2.setBounds(335, 138, 149, 33);
		panel.add(btnNewButton_2);
		
		prenomField = new JTextField();
		prenomField.setFont(new Font("Tw Cen MT", Font.PLAIN, 11));
		prenomField.setColumns(10);
		prenomField.setBounds(124, 65, 131, 20);
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("NUM");
		lblNewLabel_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_1_1_1.setFont(new Font("Tw Cen MT", Font.PLAIN, 21));
		lblNewLabel_1_1_1.setBounds(30, 147, 53, 14);
		panel.add(lblNewLabel_1_1_1);
		
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Date B");
		lblNewLabel_1_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_1_1_1_1.setFont(new Font("Tw Cen MT", Font.PLAIN, 21));
		lblNewLabel_1_1_1_1.setBounds(23, 100, 149, 14);
		panel.add(lblNewLabel_1_1_1_1);
		
		dateChooser = new JDateChooser();
		dateChooser.setBounds(134, 96, 114, 20);
